...
var industry = /*#__PURE__*/function () {
  ...
  _createClass(IndustrySpecialization, [{
    ...
    value: function init() {
      ...
      var colums = document.querySelectorAll('.industry-specialization__column');
      var items = document.querySelectorAll('.industry-specialization-tab__navigation-item');
      var linkItems = document.querySelectorAll('.industry-specialization-tab-link-item');
      var navigations = document.querySelectorAll('.industry-specialization-tab__navigation');
      var content = document.querySelectorAll('.industry-specialization-tab-picture-item__content');
      var webs = document.querySelectorAll('.web');
      var gridRows = document.querySelectorAll('.industry-specialization-tab__grid-row');
      ...
      gridRows.forEach(function (item, idx) {
        var el = item.id = "gridRow_".concat(idx);
        Object(_resize__WEBPACK_IMPORTED_MODULE_2__["default"])([{
          element: "#gridRow_".concat(idx),
          className: 'mobile',
          size: 1023,
          isLess: true // <=
        }]);
      ...
      items.forEach(function (item, idx) {
        var el = item.id = "item_".concat(idx);
        Object(_resize__WEBPACK_IMPORTED_MODULE_2__["default"])([{
          element: "#item_".concat(idx),
          className: 'mobile',
          size: 1023,
          isLess: true // <=
        }]);
      ...
      linkItems.forEach(function (item, idx) {
        var el = item.id = "linkItems_".concat(idx);
        Object(_resize__WEBPACK_IMPORTED_MODULE_2__["default"])([{
          element: "#linkItems_".concat(idx),
          className: 'mobile',
          size: 1023,
          isLess: true // <=
        }, {
      ...
      content.forEach(function (item, idx) {
        var el = item.id = "content_".concat(idx);
        Object(_resize__WEBPACK_IMPORTED_MODULE_2__["default"])([{
          element: "#content_".concat(idx),
          className: 'mobile',
          size: 1023,
          isLess: true // <=
        }, {
          element: "#content_".concat(idx, " .industry-specialization-tab-picture-item__wrapper-text"),
          className: 'mobile',
          size: 1023,
          isLess: true // <=
        }, {
          element: "#content_".concat(idx, " .industry-specialization-tab-picture-item__text"),
          className: 'mobile',
          size: 1023,
          isLess: true // <=
        }]);
  ...
  _createClass(MainAbout, [{
    ...
    value: function init() {
      Object(_resize__WEBPACK_IMPORTED_MODULE_2__["default"])([{
        ...
        element: '.main-about__circle',
        className: 'isMobile',
        size: 1023,
        isLess: true
      }, {
        element: '.main-about__top',
        className: 'isMobile',
        size: 1023,
        isLess: true
      }, {
        element: '.main-about__title',
        className: 'isMobile',
        size: 1023,
        isLess: true
      }, {
        element: '.main-about__description',
        className: 'isMobile',
        size: 1023,
        isLess: true
      }, {
        element: '.main-about__bottom',
        className: 'isMobile',
        size: 1023,
        isLess: true
      }, {
        element: '.main-about__statistics-list',
        className: 'isMobile',
        size: 1023,
        isLess: true
      }, {
      ...
      items.forEach(function (item, idx) {
        ...
        Object(_resize__WEBPACK_IMPORTED_MODULE_2__["default"])([{
          element: "#main_about_item_".concat(idx),
          className: 'isMobile',
          size: 1023,
          isLess: true
        }, {
          element: "#main_about_item_".concat(idx, " .main-about-statistics-item__title"),
          className: 'isMobile',
          size: 1023,
          isLess: true
        }, {
          element: "#main_about_item_".concat(idx, " .main-about-statistics-item__description"),
          className: 'isMobile',
          size: 1023,
          isLess: true
        }]);
